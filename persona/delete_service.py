...
from app.models import DocumentJob, KnowledgeSpace, Persona, PersonaDraft, PersonaMemory
...
class PersonaDeletionService:
    """Coordinate deletion across Milvus, LangGraph, MySQL, and local files."""
